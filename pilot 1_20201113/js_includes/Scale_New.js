...
jqueryWidget: {
    ...
    setHandlePos: function () {
        ...
        this.$handleLabel.text(Math.round(this.fraction.toFixed(this.decimalPlaces) *100));
        ...
        if (this.options.scaleLabels) {
            this.$leftLabel.css('left', parseInt(Math.round(barLeft - this.$leftLabel.width()/2)) + 'px');
    ...
    setLinearGradient: function ($elem, startColor, endColor) {
        ...
        $elem.css('filter', "progid:DXImageTransform.Microsoft.Gradient(startColorstr='" + scol + "', endColorstr='" + ecol + "', GradientType=0)");
