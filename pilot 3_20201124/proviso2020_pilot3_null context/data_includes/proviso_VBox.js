...
[["null.presup",3], "AY_Form_inst", {consentRequired: true, html: { include: "2_null.html" }}, 
                       "SingleSlider", {s: {html: "<p>On this planet, some aliens are gogopos and some aliens are not gogopos.</p> <p><b>You notice the word 'dord' on a guidebook, but no one explains it to you.</b></p> <p>You are about to interview Diane, an alien from this planet. The information you've collected about Diane so far suggests this: <b>If Diane is a gogopo, she will yapple her dord.</b></p> "}, 
                                 s2: {html: " <br> <p>How surprised would you be to learn during the interview that ...?</p> " }, 
                                       html: "<b>Diane doesn't have a dord.</b> "} ],
[["null.ant",4], "SingleSlider", {s: {html: "<p>On this planet, some aliens are gogopos and some aliens are not gogopos.</p> <p><b>You notice the word 'dord' on a guidebook, but no one explains it to you.</b></p> <p>You are about to interview Diane, an alien from this planet. The information you've collected about Diane so far suggests this: <b>If Diane is a gogopo, she will yapple her dord.</b></p> "}, 
                               s2: {html: " <br> <p>How surprised would you be to learn during the interview that ...?</p> " }, 
