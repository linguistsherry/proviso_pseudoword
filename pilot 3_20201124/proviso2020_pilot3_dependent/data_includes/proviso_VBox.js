...
[["fulldep.presup",7], "AY_Form_inst", {consentRequired: true, html: { include: "5_fulldep.html" }}, 
                       "SingleSlider", {s: {html: "<p>On this planet, some aliens are gogopos and some aliens are not gogopos.</p> <p><b>All gogopos have a dord. No one else has dords.</b></p> <p>You are about to interview Cece, an alient from this planet. The information you've collected about Cece so far suggests this: <b>If Cece is a gogopo, she will yapple her dord.</b></p> "}, 
                                    s2: {html: " <br> <p>How surprised would you be to learn during the interview that ...?</p> " }, 
                                     html: "<b>Cece doesn't have a dord.</b> "} ],
[["fulldep.ant",8],  "SingleSlider", {s: {html: "<p>On this planet, some aliens are gogopos and some aliens are not gogopos.</p> <p><b>All gogopos have a dord. No one else has dords.</b></p> <p>You are about to interview Cece, an alient from this planet. The information you've collected about Cece so far suggests this: <b>If Cece is a gogopo, she will yapple her dord.</b></p> "}, 
                                   s2: {html: " <br> <p>How surprised would you be to learn during the interview that ...?</p> " }, 
