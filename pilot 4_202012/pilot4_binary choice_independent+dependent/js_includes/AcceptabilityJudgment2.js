...
jqueryWidget: {
    _init: function () {
        var opts = {
            ...
            triggers:    [2],
            children:    [this.options._dashed ? "DashedSentence" : "StaticSentence",
                          ...
                          this.options._dashed ? "DashedSentence" : "StaticSentence2",
                          this.options._dashed ? {
                                                     s2: this.options.s2,
                                                     mode: this.options.mode,
                                                     display: this.options.display,
...
properties: {
    ...
    htmlDescription:
        function (opts) {
            var s = ibex_controller_get_property("StaticSentence", "htmlDescription")(opts);
            var s2 = ibex_controller_get_property("StaticSentence2", "htmlDescription")(opts);
